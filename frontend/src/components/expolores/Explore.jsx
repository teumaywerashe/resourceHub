...
function Explore({ generation, setGeneration }) {
  return (
    <section
      id="explore-menu"
      className="py-12 px-4 bg-white border-b border-gray-100"
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="w-full relative group">
                ...
                >
                  <div
                    className={`relative p-1 rounded-full transition-all duration-300 ${
                      isActive
                        ? "bg-linear-to-tr from-indigo-500 to-purple-500 shadow-lg scale-110"
                  ...
                  >
                    <div className="bg-white p-1 rounded-full">
                      <img
                        src={item.image}
                        alt={item.name}
                        className={`w-20 h-20 md:w-24 md:h-24 object-cover rounded-full transition-all duration-300 ${
                          isActive
                            ? "opacity-100"
                            : "opacity-70 group-hover/item:opacity-100 grayscale group-hover/item:grayscale-0"
                        }`}
                      />
                    </div>
          ...
          <div className="absolute top-0 right-0 h-full w-12 bg-linear-to-l from-white to-transparent pointer-events-none md:hidden"></div>
          <div className="absolute top-0 left-0 h-full w-12 bg-linear-to-r from-white to-transparent pointer-events-none md:hidden"></div>
        </div>
