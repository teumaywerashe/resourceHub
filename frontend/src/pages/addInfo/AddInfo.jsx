...
const AddInfo = () => {
  const { currentUniversity,uniId, getUniversity, url } = useContext(StoreContext);
      ...
      <div className="add-info-container">
        <div className="uni-logo">
          ...
          <label htmlFor="image" className="upload-label">
            <img
              src={image ? URL.createObjectURL(image) : `${url}/uploads/${currentUniversity.logo}`}
              alt="Upload Preview"
        ...
        <div className="form-group">
          ...
          >
            ...
            <option value="Dilla University (DU)">Dilla University (DU)</option>
            ...
            <option value="Axum University (AXU)">Axum University (AXU)</option>
            ...
            <option value="Arsi University (ARU)">Arsi University (ARU)</option>
        ...
        <div className="form-group">
          <button onClick={() => updateUniversity()} className="submit-btn">
            Submit
          </button>
        </div>
      </div>
